...
const medical_consultations_routes_1 = __importDefault(require("../routes/medical.consultations.routes"));
...
class ServerApp {
    ...
    routes() {
        ...
        this.app.use(this.apiPaths.medical_consultations, medical_consultations_routes_1.default);
    }
    listen() {
